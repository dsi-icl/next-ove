    ...
    <Table>
      ...
      <TableBody>
        ...
        <TableRow>
          ...
          <TableCell>{format(display?.resolutionX)}x{format(display?.resolutionY)}</TableCell>
        </TableRow>
        <TableRow>
          <TableCell>size</TableCell>
          <TableCell>{format(display?.sizeX)}x{format(display?.sizeY)}</TableCell>
        </TableRow>
        <TableRow>
        ...
        <TableRow>
          ...
          <TableCell>{format(display?.currentResX)}x{format(display?.currentResY)}</TableCell>
        </TableRow>
        <TableRow>
          <TableCell>position</TableCell>
          <TableCell>{format(display?.positionX)}x{format(display?.positionY)}</TableCell>
        </TableRow>
        <TableRow>
