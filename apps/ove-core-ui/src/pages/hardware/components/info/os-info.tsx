...
const OSInfo = ({
  ...
  <div>
    ...
    <h4 className="mt-6 font-bold">UUIDs</h4>
    <Table>
      <TableHeader />
      <TableBody>
        <TableRow>
    ...
    <h4 className="mt-6 font-bold">Versions</h4>
    <Table>
      <TableHeader />
      <TableBody>
        {Object.entries(info.versions ?? {}).map(([k, v]) => (
          <TableRow key={k.toLowerCase()}>
    ...
    {info.users?.map((user, i) => (
      <div key={i}>
        <h4 className="mt-6 font-bold">User - {user?.user}</h4>
        <Table>
          <TableHeader />
          <TableBody>
            <TableRow>
