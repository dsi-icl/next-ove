...
const SystemInfo = ({
  ...
  <div>
    <h4 className="mt-6 font-bold">System</h4>
    <Table>
      <TableHeader />
      <TableBody>
        <TableRow>
    ...
    <h4 className="mt-6 font-bold">BIOS</h4>
    <Table>
      <TableHeader />
      <TableBody>
        <TableRow>
    ...
    <h4 className="mt-6 font-bold">Baseboard</h4>
    <Table>
      <TableHeader />
      <TableBody>
        <TableRow>
    ...
    <h4 className="mt-6 font-bold">Chassis</h4>
    <Table>
      <TableHeader />
      <TableBody>
        <TableRow>
