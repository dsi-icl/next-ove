...
const ProcessInfo = ({
  ...
  <div>
    ...
    <Table>
      ...
      <TableBody>
        ...
        <TableRow>
          ...
          <TableCell>
            {format(info.currentLoad?.rawCurrentLoadSystem)}
          </TableCell>
        </TableRow>
        <TableRow>
    ...
    {info.currentLoad?.cpus?.map((cpu, i) => (
      <div key={i}>
        <h4 className="mt-6 font-bold">CPU Core - {i}</h4>
        <Table>
          <TableHeader />
          <TableBody>
            <TableRow>
    ...
    {info.processes?.list?.map((process) => (
      <div key={process?.pid}>
        <h4 className="mt-6 font-bold">PID - {process?.pid}</h4>
        <Table>
          <TableHeader />
          <TableBody>
            <TableRow>
    ...
    {info.services?.map((service, i) => (
      <div key={i}>
        <h4 className="mt-6 font-bold">Service - {i}</h4>
        <Table>
          <TableHeader />
          <TableBody>
            <TableRow>
