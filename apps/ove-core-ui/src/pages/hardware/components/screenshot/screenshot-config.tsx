...
const ScreenshotConfig = ({ displays, method, setMethod, takeScreenshots, transition }: ScreenshotConfigProps) => {
            ...
            <PopoverContent className="w-full p-0">
              <Command>
                ...
                <CommandList>
                  ...
                  <CommandGroup>
                    {displays.map((screen) => <CommandItem
                      key={screen.value}
                    ...
                    >
                      <Check
                        className={cn(
                          "mr-2 h-4 w-4",
                          screens.includes(screen.value) ? "opacity-100" : "opacity-0"
                        )}
                      />
                      {screen.label}
                    </CommandItem>)}
