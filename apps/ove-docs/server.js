...
const version = require(process.env.PACKAGE_VERSION_LOCATION ??
...
app.use("/compatibility/css/static",
...
app.listen(process.env.PORT ?? 8080, () =>
  console.log(`Docs server listening on port ${process.env.PORT ?? 8080}`));
