...
export const DockerInfoDataSchema: z.ZodType<DockerInfoData> = z.strictObject({
  ...
  ngoroutines: z.number(),
  systemTime: z.string(),
  loggingDriver: z.string(),
  cgroupDriver: z.string(),
  nEventsListener: z.number(),
  ...
  clusterStore: z.string(),
  clusterAdvertise: z.string(),
...
export const FSSchema = z.strictObject({
  ...
  fsOpenFiles: FSOpenFilesDataSchema.array(),
  fsStats: FSStatsDataSchema,
  type: z.literal("fs")
});
